class CommonTypes:
    @staticmethod
    def self(pos: int = -1):
        from SPPCompiler.SemanticAnalysis.ASTs import TypeSingleAst, GenericIdentifierAst
        return TypeSingleAst(pos, [GenericIdentifierAst(pos, "Self", None)])

    @staticmethod
    def void(pos: int = -1):
        from SPPCompiler.SemanticAnalysis.ASTs import IdentifierAst, TypeSingleAst, GenericIdentifierAst
    ...
    def fut(inner_type, pos: int = -1):
        from SPPCompiler.SemanticAnalysis.ASTs import IdentifierAst, TypeSingleAst, GenericIdentifierAst, GenericArgumentGroupAst, GenericArgumentNormalAst, TokenAst
    ...
    def opt(inner_type, pos: int = -1):
        ...
        from SPPCompiler.LexicalAnalysis.Tokens import TokenType
        inner_type = GenericArgumentNormalAst(-1, inner_type)
        return TypeSingleAst(pos, [IdentifierAst(pos, "std"), GenericIdentifierAst(pos, "Opt", GenericArgumentGroupAst(-1, TokenAst.dummy(TokenType.TkBrackL), [inner_type], TokenAst.dummy(TokenType.TkBrackR)))])
