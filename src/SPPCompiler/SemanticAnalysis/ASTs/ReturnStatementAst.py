...
class ReturnStatementAst(Ast, SemanticAnalyser):
    ...
    def do_semantic_analysis(self, scope_handler, **kwargs) -> None:
        ...
        if not actual_return_type.symbolic_eq(target_return_type):
            raise SemanticErrors.TYPE_MISMATCH(self.expression or self.return_keyword, actual_return_type, target_return_type)
