class CommonTypes:
    ...
    @staticmethod
    def void(pos: int = -1):
        from src.SemanticAnalysis.ASTs.Ast import IdentifierAst, TypeSingleAst, GenericIdentifierAst
    ...
    def gen(gen_type=None, ret_type=None, send_type=None, pos: int = -1):
        from src.SemanticAnalysis.ASTs.Ast import IdentifierAst, TypeSingleAst, GenericIdentifierAst, GenericArgumentGroupAst, GenericArgumentNormalAst, TokenAst
